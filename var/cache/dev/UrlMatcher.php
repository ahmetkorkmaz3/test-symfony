...
return [
    ...
    [ // $staticRoutes
        ...
        '/' => [[['_route' => 'home_page', '_controller' => 'App\\Controller\\HomePage::home_page'], null, null, null, false, false, null]],
    ...
    [ // $dynamicRoutes
        ...
        310 => [[['_route' => 'fos_user_registration_confirm', '_controller' => 'fos_user.registration.controller:confirmAction'], ['token'], ['GET' => 0], null, false, true, null]],
        340 => [
